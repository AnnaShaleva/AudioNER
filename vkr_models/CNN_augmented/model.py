...
TENSORBOARD_DIR = '/headless/shared/AudioNER/vkr_models/CNN_augmented/log/'
...
def build_model(input_shape=(const.HEIGHT, const.LENGTH, 1), num_classes=const.N_CLASSES, num_subclasses=const.N_SUBCLASSES):
    ...
    conv3 = Conv2D(16, kernel_size=(1, 1), use_bias=True, padding='same', activation='relu')(dropout2)
