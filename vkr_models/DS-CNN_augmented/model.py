...
from tensorflow.keras.layers import Input, Dense, Flatten, Activation, Dropout, Conv2D, MaxPooling2D, UpSampling2D, BatchNormalization, SeparableConv2D
...
TENSORBOARD_DIR = '/headless/shared/AudioNER/vkr_models/DS-CNN_augmented/log/'
...
def build_model(input_shape=(const.HEIGHT, const.LENGTH, 1), num_classes=const.N_CLASSES, num_subclasses=const.N_SUBCLASSES):
    ...
    conv0 = Conv2D(64, kernel_size=(8, 10), use_bias=True, padding='same')(visible)
    ...
    conv1 = SeparableConv2D(64, kernel_size=(4, 10), use_bias=True, padding='same')(dropout0)
    ...
    conv2 = SeparableConv2D(256, kernel_size=(2, 5), use_bias=True, padding='same')(dropout1)
    ...
    conv3 = SeparableConv2D(16, kernel_size=(1, 1), use_bias=True, padding='same')(dropout2)
